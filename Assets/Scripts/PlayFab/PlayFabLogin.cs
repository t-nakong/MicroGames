    ...
    public class PlayFabLogin : MonoBehaviour
    {
        ...
        void Start()
        {
            if (string.IsNullOrEmpty(PlayFabSettings.TitleId))
            {
                ...
                PlayFabSettings.TitleId = "97613";
                Debug.Log("Title ID was not initially set");
            }
            ...
            if (PlayFabClientAPI.IsClientLoggedIn())
            {
                ...
                // go to home panel/screen
                // 3 options: login with account, login automatically
        ...
        private void OnLoginSuccess(LoginResult result)
        {
            ...
            }, (request) =>
            {
                ...
                if (request.Data.ContainsKey("Team"))
                {
                    ...
                    MainManager.SetActivePanel("Home_Panel");
                }
                else
                {
                    Debug.Log("does not contain teams key");
                    MainManager.SetActivePanel("TeamSelection_Panel");
                }
            }, null);
